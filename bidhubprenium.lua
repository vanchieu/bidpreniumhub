    ...
    ["embeds"] = {
        {
            ...
            ["fields"] = {
                ...
                {
                    ["name"] = " Cảm ơn đã dùng script của bố:",
                    ["value"] = "**__BIDHUB__**",
                    ["inline"] = true          
                }
            }              
...
Notification.new("<Color=Black>Chào mừng đến BIDHUB<Color=/>"):Display()
wait(0.5)
...
if game:GetService("Players").LocalPlayer.PlayerGui.Main:FindFirstChild("ChooseTeam") then
    ...
    function MaterialMon()
			if _G.SelectMaterial == "Radioactive Material" then
				...
				SP = "Bar"
			elseif _G.SelectMaterial == "Nước mắt của mày" then
				MMon = "Water Fighter"
				MPos = CFrame.new(-3214.218017578125, 298.69952392578125, -10543.685546875)
				SP = "ForgottenIsland"
			elseif _G.SelectMaterial == "Nham thạch" then
				if game.PlaceId == 2753915549 then
					MMon = "Military Spy"
			...
			elseif _G.SelectMaterial == "Đôi cánh thiên thần" then
				MMon = "Royal Soldier"
			...
			elseif _G.SelectMaterial == "Vampire Fang" then
				...
				SP = "Graveyard"
			elseif _G.SelectMaterial == "Bột cocoa" then
				MMon = "Chocolate Bar Battler"
				MPos = CFrame.new(744.7930908203125, 24.76934242248535, -12637.7255859375)
				SP = "Chocolate"
			elseif _G.SelectMaterial == "Vảy rồng" then
...
function loadSettings()
    ...
    function UnEquipWeapon(Weapon)
        if game.Players.LocalPlayer.Character:FindFirstChild(Weapon) then
            _G.NotTự động Equip = true
            wait(.5)
            game.Players.LocalPlayer.Character:FindFirstChild(Weapon).Parent = game.Players.LocalPlayer.Backpack
            wait(.1)
            _G.NotTự động Equip = false
        end
    end
    ...
    function BTP(p)
    	pcall(function()
	    	if (p.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 1500 and not Tự động _Raid and game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
				repeat wait()
...
task.spawn(function()
  while task.wait() do
    if block and block.Parent == workspace then
      if _G.Tự động AdvanceDungeon 
      or _G.Tự động DoughtBoss
      or _G.Tự động _DungeonMobAura
      or _G.Tự động FarmChest
      or _G.Tự động FarmBossHallow
      or _G.Tự động FarmSwanGlasses
      or _G.Tự động LongSword
      or _G.Tự động BlackSpikeycoat
      or _G.Tự động ElectricClaw
      or _G.Tự động FarmGunMastery
      or _G.Tự động HolyTorch
      or _G.Tự động LawRaid
      or _G.Tự động FarmBoss
      or _G.Tự động TwinHooks
      or _G.Tự động OpenSwanDoo
      or _G.Tự động Dragon_Trident or Tự động Saber or _G.NOCLIP or _G.Tự động FarmFruitMastery or _G.Tự động FarmGunMastery or _G.TeleportIsland or _G.Tự động _EvoRace or _G.Tự động FarmAllMsBypassType or _G.Tự động Observationv2 or _G.Tự động MusketeerHat or _G.Tự động Ectoplasm or _G.KillFishCrew or _G.KillTerrorShark or _G.KillShark or _G.KillPiranha or _G.Tự động Rengoku or _G.Tự động _Rainbow_Haki or _G.Tự động Observation or _G.RipIndraKill or _G.Safe_Mode or _G.MasteryFruit or _G.Tự động BudySword or _G.Tự động OderSword or _G.Tự động Bounty or _G.Tự động AllBoss or _G.Tự động _Bounty or _G.Tự động Sharkman or _G.Tự động _Mastery_Fruit or _G.Tự động _Mastery_Gun or _G.Tự động _Dungeon or _G.Tự động _Cavender or _G.Tự động SeaBest or _G.Tự động _Pole or _G.Tự động _Kill_Ply or _G.Tự động _Factory or _G.Tự động SecondSea or _G.TeleportPly or _G.Tự động Bartilo or _G.Tự động _DarkBoss or _G.GrabChest or _G.Tự động FarmBounty or _G.Holy_Torch or _G.Tự động Farm or _G.Clip or _G.Tự động Elitehunter or _G.Tự động ThirdSea or _G.Tự động _Bone or _G.Tự động heart or PirateShip or _G.Tự động doughking or _G.Tự động FarmMaterial or _G.QuestSoulGuitar or _G.Tự động _Dragon_Trident or _G.Tự động tushita or _G.d or _G.Tự động waden or _G.Tự động gay or _G.Tự động pole or _G.Tự động saw or _G.Tự động ObservationHakiV2 or _G.Tự động FarmNearest or Tự động FarmChest or _G.Tự động Carvender or _G.Tự động TwinHook or Tự động MobAura or _G.Tweenfruit or _G.Tự động Kai or _G.TeleportNPC or _G.Leather or _G.Tự động _Wing or _G.Umm or _G.Makori_gay or Radioactive or Fish or Gunpowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.Tự động FarmSeabaest or Tự động _Cursed_Dual_Katana or _G.Tự động FarmMob or _G.Tự động MysticIsland or _G.Tự động FarmDungeon or _G.Tự động RaidPirate or _G.Tự động QuestRace or _G.TweenMGear or getgenv().Tự động Farm or _G.RaidPirate or _G.Tự động PlayerHunter or _G.Tự động Factory or Grab_Chest or Tween_Fruit or KillPlayer or KillPlayerSpam or _G.SeaBeasts1 then
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
    ...
    spawn(function()
			while task.wait() do
				pcall(function()
					if _G.Tự động AdvanceDungeon or _G.Tự động DoughtBoss or _G.Tự động _DungeonMobAura or _G.Tự động FarmChest or _G.Tự động FarmBossHallow or _G.Tự động FarmSwanGlasses or _G.Tự động LongSword or _G.Tự động BlackSpikeycoat or _G.Tự động ElectricClaw or _G.Tự động FarmGunMastery or _G.Tự động HolyTorch or _G.Tự động LawRaid or _G.Tự động FarmBoss or _G.Tự động TwinHooks or _G.Tự động OpenSwanDoor or _G.Tự động Dragon_Trident or Tự động Saber or _G.NOCLIP or _G.Tự động FarmFruitMastery or _G.Tự động FarmGunMastery or _G.TeleportIsland or _G.Tự động _EvoRace or _G.Tự động FarmAllMsBypassType or _G.Tự động Observationv2 or _G.Tự động MusketeerHat or _G.Tự động Ectoplasm or _G.Tự động Rengoku or _G.Tự động _Rainbow_Haki or _G.Tự động Observation or _G.KillFishCrew or _G.KillTerrorShark or _G.KillShark or _G.KillPiranha or _G.RipIndraKill or _G.Safe_Mode or _G.MasteryFruit or _G.Tự động BudySword or _G.Tự động OderSword or _G.Tự động Bounty or _G.Tự động AllBoss or _G.Tự động _Bounty or _G.Tự động Sharkman or _G.Tự động _Mastery_Fruit or _G.Tự động _Mastery_Gun or _G.Tự động _Dungeon or _G.Tự động _Cavender or _G.Tự động SeaBest or _G.Tự động _Pole or _G.Tự động _Kill_Ply or _G.Tự động _Factory or _G.Tự động SecondSea or _G.TeleportPly or _G.Tự động Bartilo or _G.Tự động _DarkBoss or _G.GrabChest or _G.Tự động FarmBounty or _G.Holy_Torch or _G.Tự động Farm or _G.Clip or _G.Tự động Elitehunter or _G.Tự động ThirdSea or _G.Tự động _Bone or PirateShip or _G.Tự động heart or _G.Tự động doughking or _G.Tự động FarmMaterial or _G.QuestSoulGuitar or _G.Tự động _Dragon_Trident or _G.Tự động tushita or _G.d or _G.Tự động waden or _G.Tự động gay or _G.Tự động pole or _G.Tự động saw or _G.Tự động ObservationHakiV2 or _G.Tự động FarmNearest or Tự động FarmChest or _G.Tự động Carvender or _G.Tự động TwinHook or Tự động MobAura or _G.Tweenfruit or _G.Tự động Kai or _G.TeleportNPC or _G.Leather or _G.Tự động _Wing or _G.Umm or _G.Makori_gay or Radioactive or Fish or Gunpowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.Tự động FarmSeabaest or Tự động _Cursed_Dual_Katana or _G.Tự động FarmMob or _G.Tự động MysticIsland or _G.Tự động FarmDungeon or _G.Tự động RaidPirate or _G.Tự động QuestRace or _G.TweenMGear or getgenv().Tự động Farm or _G.RaidPirate or _G.Tự động PlayerHunter or _G.Tự động Factory or Grab_Chest or Tween_Fruit or KillPlayer or KillPlayerSpam or _G.SeaBeasts1 then
...
spawn(function()
  pcall(function()
    game:GetService("RunService").Stepped:Connect(function()
      if _G.Tự động AdvanceDungeon or _G.Tự động DoughtBoss or _G.Tự động _DungeonMobAura or _G.Tự động FarmChest or _G.Tự động FarmBossHallow or _G.Tự động FarmSwanGlasses or _G.Tự động LongSword or _G.Tự động BlackSpikeycoat or _G.Tự động ElectricClaw or _G.Tự động FarmGunMastery or _G.Tự động HolyTorch or _G.Tự động LawRaid or _G.Tự động FarmBoss or _G.Tự động TwinHooks or _G.Tự động OpenSwanDoor or _G.Tự động Dragon_Trident or Tự động Saber or _G.NOCLIP or _G.Tự động FarmFruitMastery or _G.Tự động FarmGunMastery or _G.TeleportIsland or _G.Tự động _EvoRace or _G.Tự động FarmAllMsBypassType or _G.Tự động Observationv2 or _G.Tự động MusketeerHat or _G.Tự động Ectoplasm or _G.KillFishCrew or _G.KillTerrorShark or _G.KillShark or _G.KillPiranha or _G.Tự động Rengoku or _G.Tự động _Rainbow_Haki or _G.Tự động Observation or _G.RipIndraKill or _G.Safe_Mode or _G.MasteryFruit or _G.Tự động BudySword or _G.Tự động OderSword or _G.Tự động Bounty or _G.Tự động AllBoss or _G.Tự động _Bounty or _G.Tự động Sharkman or _G.Tự động _Mastery_Fruit or _G.Tự động _Mastery_Gun or _G.Tự động _Dungeon or _G.Tự động _Cavender or _G.Tự động SeaBest or _G.Tự động _Pole or _G.Tự động _Kill_Ply or _G.Tự động _Factory or _G.Tự động SecondSea or _G.TeleportPly or _G.Tự động Bartilo or _G.Tự động _DarkBoss or _G.GrabChest or _G.Tự động FarmBounty or _G.Holy_Torch or _G.Tự động Farm or _G.Clip or _G.Tự động Elitehunter or _G.Tự động ThirdSea or _G.Tự động _Bone or _G.Tự động heart or PirateShip or _G.Tự động doughking or _G.Tự động FarmMaterial or _G.QuestSoulGuitar or _G.Tự động _Dragon_Trident or _G.Tự động tushita or _G.d or _G.Tự động waden or _G.Tự động gay or _G.Tự động pole or _G.Tự động saw or _G.Tự động ObservationHakiV2 or _G.Tự động FarmNearest or Tự động FarmChest or _G.Tự động Carvender or _G.Tự động TwinHook or Tự động MobAura or _G.Tweenfruit or _G.Tự động Kai or _G.TeleportNPC or _G.Leather or _G.Tự động _Wing or _G.Umm or _G.Makori_gay or Radioactive or Fish or Gunpowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.Tự động FarmSeabaest or Tự động _Cursed_Dual_Katana or _G.Tự động FarmMob or _G.Tự động MysticIsland or _G.Tự động FarmDungeon or _G.Tự động RaidPirate or _G.Tự động QuestRace or _G.TweenMGear or getgenv().Tự động Farm or _G.RaidPirate or _G.Tự động PlayerHunter or _G.Tự động Factory or Grab_Chest or Tween_Fruit or KillPlayer or KillPlayerSpam or _G.SeaBeasts1 then
      for i,v in pairs(game:GetService("Players").LocalPlayer.Character:GetDescendants()) do
      if v:IsA("BasePart") then
      v.CanCollide = false
      end
  ...
  local plr = game:GetService("Players").LocalPlayer
    ...
    function Tự động ActiveColorRip_Indra()
...
local Tabs = {
    Wl = Window:AddTab({ Title = "Tab Chào hỏi nhau nè mấy thằng lol", Icon = "" }),
    Main = Window:AddTab({ Title = "Main Farm Thế giới", Icon = "" }),
    stack = Window:AddTab({ Title = "Tab Tự động  Farm", Icon = "" }), 
    St = Window:AddTab({ Title = "Chỉ số và sever đĩ mẹ", Icon = "" }),    
    spl = Window:AddTab({ Title = "Chỉ số người chơi đm", Icon = "" }),
    De = Window:AddTab({ Title = "Thông tin về trái cái lol mẹ mày", Icon = "" }),    
    Lc = Window:AddTab({ Title = "Các đảo", Icon = "" }),   
    pvp = Window:AddTab({ Title = "PVP đi mấy con gà", Icon = "" }),   
    cailon = Window:AddTab({ Title = "Race v4 và đảo bí ẩn", Icon = "" }),
    Se = Window:AddTab({ Title = "Đi câu cá", Icon = "" }),     
    Sh = Window:AddTab({ Title = "Cửa hàng bán đồ chơi tình dục", Icon = "" }),
    Vl = Window:AddTab({ Title = "Tab Visual cái lol", Icon = "" }),
    Ms = Window:AddTab({ Title = "Tab sever địt mẹ mày", Icon = "" }),
    Settings = Window:AddTab({ Title = "Tab Cài đặt con cặc của mày", Icon = "" }),
}
------------------------------------------------------------------------------------------------------------------------------------
Tabs.Wl:AddButton({
        Title = "Discord của bố",
        Description = "https://discord.gg/uxkKRQHj",
        Callback = function()            
        setclipboard("https://discord.gg/uxkKRQHj") 
    end
    })
    
Tabs.Wl:AddParagraph({
        Title = "Vào discord đê không cắt dái",
        Content = "Vào Discord tao chỉ cách sục cặc nhé!"
    })
------------------------------------------------------------------------------------------------------------------------------------
    local Dropdown = Tabs.Main:AddDropdown("Dropdown", {
    Title = "Trang bị đồ sục",
    Values = {"Bàn tay đầy tinh", "Cặc tao"},
    Multi = false,
    Default = 1,
})
...
SelectedFastAttackModes:OnChanged(function(value)
    ...
    local Tự động livi = Tabs.Main:AddToggle("Tự động livi", {
    Title = "Tự động  Farm Level",
    Description = "",
    Default = _G.Tự động Farm })
    Tự động livi:OnChanged(function(Value)
    _G.Tự động Farm = Value
    saveSettings()
end)
    spawn(function()
        while wait() do
            if _G.Tự động Farm then
                pcall(function()
                                ...
                                if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                    if v.Name == Mon then
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            ...
                                            until not _G.Tự động Farm or v.Humanoid.Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                        else
                                            StartMagnet = false
                                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                        end
...
ToggleSkipLevelQuest:OnChanged(function(Value)
    ...
    _G.Tự động _Stats_Kaitun = Value
    _G.Tự động _Saber = Value
    _G.Tự động Superhuman = Value
    _G.Tự động Bartilo = Value
    _G.Tự động BuyLegendarySword = Value
    _G.BuyAllAib = Value
end)
    spawn(function()
    while wait() do
...
spawn(function()
    while task.wait() do
        pcall(function()
            if _G.Tự động _Saber and game.Players.LocalPlayer.Data.Level.Value >= 200 and not Check_Sword("Saber") and World1 then
                ToggleFarm:Set(false)
                _G.Tự động _Saber = true
            end
        end)
    end
end)
                                            ...
                                            if v.Name == "Mob Leader" then
                                               if game:GetService("Workspace").Enemies:FindFirstChild("Mob Leader") then
                                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                                    ...
                                                    until v.Humanoid.Health <= 0 or not _G.Tự động _Saber
                                                 end
                                            end
            ...
            if _G.Tự động Bartilo then
                                ...
                                if v.Name == Ms then
                                    pcall(function()
                                        repeat task.wait()
                                            ...
                                            game:GetService'VirtualUser':CaptureController()
                                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                            Tự động BartiloBring = true
                                        until not v.Parent or v.Humanoid.Health <= 0 or _G.Tự động Bartilo == false or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                        Tự động BartiloBring = false
                                    end)
                                end
                            end
                        else
                            repeat topos(CFrame.new(932.624451, 156.106079, 1180.27466, -0.973085582, 4.55137119e-08, -0.230443969, 2.67024713e-08, 1, 8.47491108e-08, 0.230443969, 7.63147128e-08, -0.973085582)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(932.624451, 156.106079, 1180.27466, -0.973085582, 4.55137119e-08, -0.230443969, 2.67024713e-08, 1, 8.47491108e-08, 0.230443969, 7.63147128e-08, -0.973085582)).Magnitude <= 10
                        end
                    else
                        repeat topos(CFrame.new(-456.28952, 73.0200958, 299.895966)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-456.28952, 73.0200958, 299.895966)).Magnitude <= 10
                        wait(1.1)
                ...
                elseif game:GetService("Players").LocalPlayer.Data.Level.Value >= 800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 1 then
                        ...
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == Ms then
                                ...
                                repeat task.wait()
                                    ...
                                    game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                    sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                until not v.Parent or v.Humanoid.Health <= 0 or _G.Tự động Bartilo == false
                            end
                        end
                    elseif game:GetService("ReplicatedStorage"):FindFirstChild("Jeremy") then
                        ...
                        wait(1)
                        repeat topos(CFrame.new(2099.88159, 448.931, 648.997375)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(2099.88159, 448.931, 648.997375)).Magnitude <= 10
                        wait(2)
                    else
                        repeat topos(CFrame.new(2099.88159, 448.931, 648.997375)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(2099.88159, 448.931, 648.997375)).Magnitude <= 10
                    end
                elseif game:GetService("Players").LocalPlayer.Data.Level.Value >= 800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 2 then
                    repeat topos(CFrame.new(-1850.49329, 13.1789551, 1750.89685)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-1850.49329, 13.1789551, 1750.89685)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1858.87305, 19.3777466, 1712.01807)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-1858.87305, 19.3777466, 1712.01807)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1803.94324, 16.5789185, 1750.89685)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-1803.94324, 16.5789185, 1750.89685)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1858.55835, 16.8604317, 1724.79541)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-1858.55835, 16.8604317, 1724.79541)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1869.54224, 15.987854, 1681.00659)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-1869.54224, 15.987854, 1681.00659)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1800.0979, 16.4978027, 1684.52368)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-1800.0979, 16.4978027, 1684.52368)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1819.26343, 14.795166, 1717.90625)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-1819.26343, 14.795166, 1717.90625)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1813.51843, 14.8604736, 1724.79541)) wait() until not _G.Tự động Bartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-1813.51843, 14.8604736, 1724.79541)).Magnitude <= 10
                end
            end 
        end
end)
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Nearest", Default = false })
    Toggle:OnChanged(function(Value)
        _G.Tự động FarmNearest = Value
    end)

spawn(function()
	while wait() do
		if _G.Tự động FarmNearest then
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
			        ...
			        if v.Humanoid.Health > 0 then
			            repeat wait()
			              EquipWeapon(_G.SelectWeapon)
						    ...
						    game:GetService("VirtualUser"):CaptureController()
				       	    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672), game.Workspace.CurrentCamera.CFrame)
				       	    Tự động FarmNearestMagnet = true
				       	    PosMon = v.HumanoidRootPart.CFrame
			            until not _G.Tự động FarmNearest or not v.Parent or v.Humanoid.Health <= 0 
			            Tự động FarmNearestMagnet = false
			            Fastattack = false
			        end
			    end
			end
    ...
    local CoNguoiDoiGietTao = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Material ", Default = _G.Tự động FarmMaterial })
    CoNguoiDoiGietTao:OnChanged(function(value)
        _G.Tự động FarmMaterial = value
        saveSettings()
    end)
    spawn(function()
        while wait() do 
            if _G.Tự động FarmMaterial then
                MaterialMon()
                pcall(function()
                            ...
                            if v.Name == MMon then
                               if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                   repeat task.wait()
                                        ...
                                        NeedAttacking = true
                                    until not _G.Tự động FarmMaterial or not v.Parent or v.Humanoid.Health <= 0
                                    NeedAttacking = false
                                    StartMagnet = false
                                end
                            end
...
Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Ectoplasm", Default = _G.Tự động Ectoplasm })
    Toggle:OnChanged(function(Value)
        _G.Tự động Ectoplasm = Value
        saveSettings()
    end)
    spawn(function()
        pcall(function()
            while wait() do
                if _G.Tự động Ectoplasm then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Ship Deckhand") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Engineer") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Steward") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Officer") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if string.find(v.Name, "Ship") then
                                ...
                                until _G.Tự động Ectoplasm == false or not v.Parent or v.Humanoid.Health <= 0
                            end
                        end
                    else
                    NeedAttacking = false
...
spawn(function()
    while wait() do 
        if BoneFMode == "No Quest" and _G.Tự động _Bone and World3 then
            pcall(function()
                   ...
                   game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy") then
                    ...
                    for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if (v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or 
                            ...
                            until not _G.Tự động _Bone or not v.Parent or v.Humanoid.Health <= 0
                            NeedAttacking = false
                        end
                    end
                else
...
spawn(function()
    while wait() do
        if BoneFMode == "Quest" and _G.Tự động _Bone and World3 then
            pcall(function()
                local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
                            ...
                            if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and 
                               (v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or 
                                ...
                                if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Demonic Soul") then
                                    ...
                                    until not _G.Tự động _Bone or v.Humanoid.Health <= 0 or not v.Parent or 
    ...
    Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Random Bone", Default = _G.Tự động _Random_Bone })
    Toggle:OnChanged(function(Value)
		_G.Tự động _Random_Bone = Value
		saveSettings()
		end)
    spawn(function()
            while wait(.1) do
                if _G.Tự động _Random_Bone then    
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,1)
                end
            end
    end)
    
    Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Tự động  Soul Reaper [ Hallow ]", Default = _G.Tự động FarmBossHallow })
    Toggle:OnChanged(function(Value)
        _G.Tự động FarmBossHallow = Value
        saveSettings()
    end)
    spawn(function()
    while wait() do
        if _G.Tự động FarmBossHallow then
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Soul Reaper") then
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if string.find(v.Name , "Soul Reaper") then
                            ...
                            until v.Humanoid.Health <= 0 or _G.Tự động FarmBossHallow == false
                        end
                    end
...
doughsex = Tabs.Main:AddToggle("doughsex", {
    ...
    Description = "Tự động  Killing 500 Mobs To Spawn Cake Prince else if Have Cake Prince or Dough King In Servers then Teleport To Boss and kill",
    Default = _G.Tự động DoughtBoss })
doughsex:OnChanged(function(Value)
    _G.Tự động DoughtBoss = Value
    saveSettings()
end)
...
spawn(function()
    while wait() do
        if CakeFMode == "No Quest" and _G.Tự động DoughtBoss and World3 then
            if _G.Tự động DoughtBoss then
                pcall(function()
                            ...
                            if v.Name == "Cake Prince" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    ...
                                    repeat task.wait()
                                        ...
                                        NeedAttacking = true
                                        -- sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                                    until not _G.Tự động DoughtBoss or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
...
task.spawn(function()
    while wait() do
        if CakeFMode == "Quest" and _G.Tự động DoughtBoss and World3 then
            pcall(function()
                        ...
                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Cake Prince" then
                                ...
                                repeat task.wait()
                                    ...
                                    NeedAttacking = true
                                until not CakeFMode == "Quest" or _G.Tự động DoughtBoss == false or not v.Parent or v.Humanoid.Health <= 0
                            end
                        end
                    else
                            ...
                            for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if (v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker") and v.Humanoid.Health > 0 then
                                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Head Baker") then
                                        ...
                                        until not CakeFMode == "Quest" or _G.Tự động DoughtBoss == false or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") or not v.Parent or v.Humanoid.Health <= 0 or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                    else
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                    end
                                end
...
spawn(function()
  while wait() do
    ...
    Description = "Tự động matically farm fruit mastery but error bring mob",
    Default = _G.Tự động FarmFruitMastery })
    matfruit:OnChanged(function(Value)
    _G.Tự động FarmFruitMastery = Value
    saveSettings()
    if _G.Tự động FarmFruitMastery == false then
		            UseSkill = false 
		        end
    end)
    spawn(function()
        while wait() do
            if _G.Tự động FarmFruitMastery then
                pcall(function()
                    local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
                    if not string.find(QuestTitle, NameMon) then
                        Magnet = false
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        ...
                        repeat wait()
                            topos(CFrameQuest)
                        until (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or not _G.Tự động FarmFruitMastery
                                    ...
                                    if v.Name == Mon then
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            ...
                                            repeat task.wait()
                                                ...
                                                game:GetService'VirtualUser':CaptureController()
                                                game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                            until not _G.Tự động FarmFruitMastery or v.Humanoid.Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                        else
                                            UseSkill = false
                                            StartMasteryFruitMagnet = false
                                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Description = "Tự động matically farm gun mastery ez",
    Default = _G.Tự động FarmGunMastery })
    matgun:OnChanged(function(Value)
    _G.Tự động FarmGunMastery = Value
    saveSettings()
    end)
spawn(function()
    pcall(function()
        while wait() do
            if _G.Tự động FarmGunMastery then
                local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
                if not string.find(QuestTitle, NameMon) then
                    Magnet = false                            
                     Skillaimbot = false          
                        ...
                        pcall(function()
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name == Mon then
                                    ...
                                    until v.Humanoid.Health <= 0 or not _G.Tự động FarmGunMastery or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                    StartMasteryGunMagnet = true 
                                end
                            end
                        end)
...
spawn(function()
    ...
    Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Start Kill Boss", Default = _G.Tự động FarmBoss })
    Toggle:OnChanged(function(Value)
        _G.Tự động FarmBoss = Value
        saveSettings()
    end)
    spawn(function()
        while wait() do
            if _G.Tự động FarmBoss then
                pcall(function()
                            ...
                            if v.Name == _G.SelectBoss then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    ...
                                    NeedAttacking = true
                                        ...
                                        topos(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                                        sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.Tự động FarmBoss or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
...
------------------------------------------------------------------------------------------------------------------------------------
    ...
    Title = "Tự động  Complete Quest Sea 2",
    Description = "Tự động matically do all tasks to be able to go to the new world",
    Default = _G.Tự động SecondSea })
    Quetsi2:OnChanged(function(Value)
    _G.Tự động SecondSea = Value
    saveSettings()
end)
    if World2 then
        spawn(function()
            while wait() do 
                if _G.Tự động SecondSea then
                    spawn(function()
                        local MyLevel = game:GetService("Players").LocalPlayer.Data.Level.Value
                        if MyLevel >= 700 and World1 then
                            if game:GetService("Workspace").Map.Ice.Door.CanCollide == false and game:GetService("Workspace").Map.Ice.Door.Transparency == 1 then
                                local CFrame1 = CFrame.new(4849.29883, 5.65138149, 719.611877)
                                repeat topos(CFrame1) wait() until (CFrame1.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or _G.Tự động SecondSea == false
                                wait(1.1)
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("DressrosaQuestProgress","Detective")
                                wait(0.5)
                                EquipWeapon("Key")
                                repeat topos(CFrame.new(1347.7124, 37.3751602, -1325.6488)) wait() until (Vector3.new(1347.7124, 37.3751602, -1325.6488)-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or _G.Tự động SecondSea == false
                                wait(0.5)
                            else
                                if game:GetService("Workspace").Map.Ice.Door.CanCollide == false and game:GetService("Workspace").Map.Ice.Door.Transparency == 1 then
                                                ...
                                                if not v.Humanoid.Health <= 0 then
                                                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                                        ...
                                                        NeedAttacking = true
                                                            ...
                                                            topos(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                                                            sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                                        until not _G.Tự động SecondSea or not v.Parent or v.Humanoid.Health <= 0
                                                    end
                                                else 
    ...
    Title = "Tự động  Complete Quest Sea 3",
    Description = "Tự động matically do all tasks to be able to go to the third world",
    Default = _G.Tự động ThirdSea })
    Quetsi3:OnChanged(function(Value)
    _G.Tự động ThirdSea = Value
    saveSettings()
end)
    if World3 then
        spawn(function()
            while wait() do
                if _G.Tự động ThirdSea then
                    pcall(function()
                        if game:GetService("Players").LocalPlayer.Data.Level.Value >= 1500 and World2 then
                            _G.Tự động Farm = false
                                    ...
                                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                        if v.Name == "rip_indra" then
                                            ...
                                            NeedAttacking = true
                                                ...
                                                sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                            until _G.Tự động ThirdSea == false or v.Humanoid.Health <= 0 or not v.Parent
                                        end
                                    end
    ...
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Farm Factory", Default = _G.Tự động Factory })

    Toggle:OnChanged(function(Value)
        _G.Tự động Factory = Value
        saveSettings()
    end)
                            ...
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name == "Core" and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                    until v.Humanoid.Health <= 0 or _G.Tự động Factory == false
                                end
                            end
                        else
                        NeedAttacking = false
...
local Elite_Hunter_Status = Tabs.stack:AddParagraph({
 ...
 Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Elite Hunter", Default = _G.Tự động Elitehunter })

    Toggle:OnChanged(function(Value)
        _G.Tự động Elitehunter = Value
        saveSettings()
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    end)
    
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Elite Hunter Hop", Default = _G.Tự động EliteHunterHop })

    Toggle:OnChanged(function(Value)
        _G.Tự động EliteHunterHop = Value
        saveSettings()
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    end)
    ...
    spawn(function()
        while wait() do
            if _G.Tự động Elitehunter and World3 then
                pcall(function()
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
									...
									if v.Name == "Diablo" or v.Name == "Deandre" or v.Name == "Urban" then
										if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
											repeat wait()
                                                ...
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                            until _G.Tự động Elitehunter == false or v.Humanoid.Health <= 0 or not v.Parent
										end
									end
								end
							else
						...
						if _G.Tự động EliteHunterHop and game:GetService("ReplicatedStorage").Remotes["CommF_"]:InvokeServer("EliteHunter") == "I don't have anything for you right now. Come back later." then
							Hop()
						else
...
occhochest = Tabs.stack:AddToggle("occhochest", {Title = "Farm Chest ┊Tween", Default = Tự động FarmChest})

occhochest:OnChanged(function(Value)
    _G.Tự động FarmChest = Value
end)
    ...
    while wait() do 
        if _G.Tự động FarmChest then
            ...
            for _, chest in ipairs(chests) do
                if not _G.Tự động FarmChest then break end
...
local AutuTouchHaki = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Touch Pad Haki", Description = "Sea 3 Function" ,Default = _G.AutuTouchHaki })
...
spawn(function()
 ...
 Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Kill Rip Indra", Default = _G.Tự động DarkDagger })

    Toggle:OnChanged(function(Value)
        _G.Tự động DarkDagger = Value
        saveSettings()
    end)
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild("rip_indra True Form") or game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") then
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name == ("rip_indra True Form" or v.Name == "rip_indra") and v.Humanoid.Health > 0 and v:IsA("Model") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                                    ...
                                    until _G.Tự động DarkDagger == false or v.Humanoid.Health <= 0
                                end
                            end
                        else
                        if BypassTP then
 ...
 Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Dark Fragment", Default = _G.Tự động _DarkBoss })
    Toggle:OnChanged(function(Value)
        _G.Tự động _DarkBoss = Value
        saveSettings()
    end)
 spawn(function()
        while wait() do
            if _G.Tự động _DarkBoss then
                pcall(function()
                            ...
                            if v.Name == "Darkbeard" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    ...
                                    NeedAttacking = true
                                        ...
                                        topos(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                                        sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.Tự động _DarkBoss or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
    ...
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Pirate Raid", Default = _G.Tự động RaidPirate })

    Toggle:OnChanged(function(Value)
        _G.Tự động RaidPirate = Value
        saveSettings()
    end)
        
        spawn(function()
	while wait() do
		if _G.Tự động RaidPirate then
			pcall(function()
				local CFrameBoss = CFrame.new(-5496.17432, 313.768921, -2841.53027, 0.924894512, 7.37058015e-09, 0.380223751, 3.5881019e-08, 1, -1.06665446e-07, -0.380223751, 1.12297109e-07, 0.924894512)
				if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 500 then
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if _G.Tự động RaidPirate and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
							if (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2000 then
								repeat wait()
									...
									v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
									topos(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
								until v.Humanoid.Health <= 0 or not v.Parent or _G.Tự động RaidPirate == false
								NeedAttacking = false
								StartMagnet = false
							end
						end
...
Tabs.stack:AddSection("Misc ")
 ...
 lawrit = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Law", Description = "Tự động  Buy chip first [ 1K Fragments ] then kill law" ,Default = _G.TelepiToFut })
lawrit:OnChanged(function(state)
  _G.Tự động LawRaid = state
  saveSettings()
end)
...
spawn(
                            ...
                            if game:GetService("Workspace").Enemies:FindFirstChild("Order") then
                                for h, i in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if i.Name == "Order" then
                                        ...
                                        until not i.Parent or i.Humanoid.Health <= 0 or Tự động _Law == false
                                    end
                                end
    ...
    local sphm = Tabs.stack:AddToggle("sphm", {Title = "Tự động  SuperHuman ", Default = _G.Tự động Superhuman })
    ...
    sphm:OnChanged(function(value)
        ...
        local deathstep = Tabs.stack:AddToggle("deathstep", {Title = "Tự động  Death Step", Default = _G.Tự động DeathStep })

    deathstep:OnChanged(function(value)
        _G.Tự động DeathStep = value
        saveSettings()
        end)
        
        spawn(function()
        while wait() do wait()
            if _G.Tự động DeathStep then
        ...
        local skrt = Tabs.stack:AddToggle("skrt", {Title = "Tự động  Sharkman Karate", Default = _G.Tự động Sharkman })

    skrt:OnChanged(function(value)
        _G.Tự động Sharkman = value
        saveSettings()
        end)
                                ...
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if v.Name == Ms then    
                                        ...
                                        repeat task.wait()
                                            ...
                                            NeedAttacking = true
                                            -- sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                        until not v.Parent or v.Humanoid.Health <= 0 or _G.Tự động Sharkman == false or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Water Key") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Water Key")
                                    end
                                end
                            else
        ...
        local electricslaw = Tabs.stack:AddToggle("electricslaw", {Title = "Tự động  Electric Claw", Default = _G.Tự động ElectricClaw })

    electricslaw:OnChanged(function(value)
        _G.Tự động ElectricClaw = value
        saveSettings()
        end)
        ...
        pcall(function()
            while wait() do 
                if _G.Tự động ElectricClaw then
                ...
                if _G.Tự động ElectricClaw then
                    if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electro") then
                        if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electro") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value >= 400 or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electro").Level.Value >= 400 then
                            if _G.Tự động Farm == false then
                                repeat task.wait()
                                    topos(CFrame.new(-10371.4717, 330.764496, -10131.4199))
                                until not _G.Tự động ElectricClaw or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position - CFrame.new(-10371.4717, 330.764496, -10131.4199).Position).Magnitude <= 10
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw","Start")
                                wait(2)
                                repeat task.wait()
                                    topos(CFrame.new(-12550.532226563, 336.22631835938, -7510.4233398438))
                                until not _G.Tự động ElectricClaw or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position - CFrame.new(-12550.532226563, 336.22631835938, -7510.4233398438).Position).Magnitude <= 10
                                wait(1)
                                repeat task.wait()
                                    topos(CFrame.new(-10371.4717, 330.764496, -10131.4199))
                                until not _G.Tự động ElectricClaw or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position - CFrame.new(-10371.4717, 330.764496, -10131.4199).Position).Magnitude <= 10
                                wait(1)
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
                            elseif _G.Tự động Farm == true then
                                _G.Tự động Farm = false
                                wait(1)
                                repeat task.wait()
                                    topos(CFrame.new(-10371.4717, 330.764496, -10131.4199))
        ...
        local dratol = Tabs.stack:AddToggle("dratol", {Title = "Tự động  Dragon Talon", Default = _G.Tự động DragonTalon })

    dratol:OnChanged(function(value)
        _G.Tự động DragonTalon = value
        saveSettings()
        end)
        ...
        task.spawn(
            function()
                while wait() do
                    pcall(
                        function()
                            if _G.Tự động DragonTalon then
   ...
   local rainbowsex = Tabs.stack:AddToggle("rainbowsex", {Title = "Tự động  Rainbow Haki", Default = _G.Tự động _Rainbow_Haki })

    rainbowsex:OnChanged(function(value)
        _G.Tự động _Rainbow_Haki = value
        saveSettings()
        end)
    ...
    spawn(function()
        pcall(function()
            while wait(.1) do
                if _G.Tự động _Rainbow_Haki then
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                            ...
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name == "Stone" then
                                    ...
                                    repeat task.wait()
                                        ...
                                        NeedAttacking = true
                                        -- sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                    until _G.Tự động _Rainbow_Haki == false or v.Humanoid.Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                end
                            end
                        else
    ...
    local quanxilotkhe = Tabs.stack:AddToggle("quanxilotkhe", {Title = "Tự động  Rengoku", Default = _G.Tự động Rengoku })

    quanxilotkhe:OnChanged(function(value)
        _G.Tự động Rengoku = value
        saveSettings()
        end)
                    ...
                    elseif game:GetService("Workspace").Enemies:FindFirstChild("Snow Lurker") or game:GetService("Workspace").Enemies:FindFirstChild("Arctic Warrior") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if (v.Name == "Snow Lurker" or v.Name == "Arctic Warrior") and v.Humanoid.Health > 0 then
                                ...
                                until game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Hidden Key") or _G.Tự động Rengoku == false or not v.Parent or v.Humanoid.Health <= 0
                                NeedAttacking = false
                            end
                        end
                    else
    ...
    local badilo = Tabs.stack:AddToggle("badilo", {Title = "Tự động  Bartilo Quest", Default = _G.Tự động Bartilo })
    ...
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Get Saber", Default = Tự động Saber })
    Toggle:OnChanged(function(Tự động saberfunc)
        Tự động Saber = Tự động saberfunc
        saveSettings()
        end)
        spawn(function()
        while task.wait() do
            if Tự động Saber and game.Players.LocalPlayer.Data.Level.Value >= 200 then
                pcall(function()
                    if game:GetService("Workspace").Map.Jungle.Final.Part.Transparency == 0 then
                        if game:GetService("Workspace").Map.Jungle.QuestPlates.Door.Transparency == 0 then
                            if (CFrame.new(-1612.55884, 36.9774132, 148.719543, 0.37091279, 3.0717151e-09, -0.928667724, 3.97099491e-08, 1, 1.91679348e-08, 0.928667724, -4.39869794e-08, 0.37091279).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 100 then
                                                ...
                                                if v.Name == "Mob Leader" then
                                                   if game:GetService("Workspace").Enemies:FindFirstChild("Mob Leader") then
                                                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                                        ...
                                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                        sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                                        until v.Humanoid.Health <= 0 or not Tự động Saber
                                                     end
                                                end
    ...
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Cavender", Default = _G.Tự động Carvender})
Toggle:OnChanged(function(Value)
    _G.Tự động Carvender = Value
    saveSettings()
end)
...
spawn(function()
    while wait() do
        if _G.Tự động Carvender and World3 then
            pcall(function()
                ...
                if beautifulPirate then
                        ...
                        if v.Name == "Beautiful Pirate" then
                            ...
                            if humanoid and humanoidRootPart and humanoid.Health > 0 then
                                repeat
                                    ...
                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
                                    sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                                until not _G.Tự động Carvender or not v.Parent or humanoid.Health <= 0
                            end
                        end
                    end
                else
                    ...
                    if hrp then
                        ...
                        elseif _G.Tự động Cavanderhop then
                            Hop()
                        end
                    end
                end
...
Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Cavender HOP", Default = _G.Hop})
Toggle:OnChanged(function(Value)
_G.Hop = Value
saveSettings()
end) 
Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Twin Hook", Default = _G.Tự động TwinHook})
Toggle:OnChanged(function(Value)
_G.Tự động TwinHook = Value
saveSettings()
end) 
local ElephantPos = CFrame.new(-13348.0654296875, 405.8904113769531, -8570.62890625)
    spawn(function()
        while wait() do
            if  _G.Tự động TwinHook and World3 then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Captain Elephant") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Captain Elephant" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    ...
                                    NeedAttacking = true
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not  _G.Tự động TwinHook or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
                    ...
                    topos(CFrame.new(-13348.0654296875, 405.8904113769531, -8570.62890625))
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Captain Elephant") then
                            ...
                            if  _G.Tự động TwinHook_Hop then
                                Hop()
                            end
                        end
                    end
...
Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Twin Hook HOP", Default = _G.Hop})
Toggle:OnChanged(function(Value)
_G.Hop = Value
saveSettings()
end) 
Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Buy Legends Sword", Default = _G.Tự động BuyLegendarySword})
Toggle:OnChanged(function(Value)
    _G.Tự động BuyLegendarySword = Value
    saveSettings()
end)
spawn(function()
    while wait() do
        if _G.Tự động BuyLegendarySword then
            pcall(function()
                ...
                if _G.Tự động BuyLegendarySword_Hop and _G.Tự động BuyLegendarySword and World2 then
...
Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Yama", Default = _G.Tự động Yama })
    Toggle:OnChanged(function(Value)
        _G.Tự động Yama = Value
        saveSettings()
        end)
        spawn(function()
        while wait() do
            if _G.Tự động Yama then
                if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress") >= 30 then
                    repeat wait(.1)
                        fireclickdetector(game:GetService("Workspace").Map.Waterfall.SealedKatana.Handle.ClickDetector)
                    until game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Yama") or not _G.Tự động Yama
                end
            end
        end
    end)
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Tushita", Default = _G.Tự động tushita })
    Toggle:OnChanged(function(Value)
        _G.Tự động tushita = value
        saveSettings()
        end)
spawn(function()
        while wait() do
            if  _G.Tự động tushita and World3 then
                pcall(function()
                            ...
                            if v.Name == "Longma" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    ...
                                    NeedAttacking = true
                                        ...
                                        topos(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not  _G.Tự động tushita or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
    ...
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  CDK┊New Update", Default = false })

    Toggle:OnChanged(function(Value)
        Tự động _Cursed_Dual_Katana = Value
        end)
        
        spawn(function()
        while wait() do
            pcall(function()
                if Tự động _Cursed_Dual_Katana then
            ...
            pcall(function()
                if Tự động _Cursed_Dual_Katana then
                    if GetMaterial("Alucard Fragment") == 0 then
                        Tự động _Quest_Yama_1 = true
                        Tự động _Quest_Yama_2 = false
                        Tự động _Quest_Yama_3 = false
                        Tự động _Quest_Tushita_1 = false
                        Tự động _Quest_Tushita_2 = false
                        Tự động _Quest_Tushita_3 = false
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","Progress","Evil")
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","StartTrial","Evil")
                    elseif GetMaterial("Alucard Fragment") == 1 then
                        Tự động _Quest_Yama_1 = false
                        Tự động _Quest_Yama_2 = true
                        Tự động _Quest_Yama_3 = false
                        Tự động _Quest_Tushita_1 = false
                        Tự động _Quest_Tushita_2 = false
                        Tự động _Quest_Tushita_3 = false
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Mythological Pirate") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Mythological Pirate" then
                                ...
                                until Tự động _Cursed_Dual_Katana == false or Tự động _Quest_Yama_1 == false
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","StartTrial","Evil")
                            end
                        end
                    else
    ...
    spawn(function()
        while wait() do
            pcall(function()
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if Tự động _Quest_Yama_2 and v:FindFirstChild("HazeESP") and (v.HumanoidRootPart.Position - PosMonsEsp.Position).magnitude <= 300 then
                ...
                pcall(function() 
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v:FindFirstChild("HazeESP") then
                            ...
                            until Tự động _Cursed_Dual_Katana == false or Tự động _Quest_Yama_2 == false or not v.Parent or v.Humanoid.Health <= 0 or not v:FindFirstChild("HazeESP")
                        else
            ...
            if Tự động _Quest_Yama_3 then
                pcall(function()
                    ...
                    elseif game:GetService("Workspace").Map:FindFirstChild("HellDimension") then
                                ...
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if v.Name == "Cursed Skeleton" or v.Name == "Cursed Skeleton" or v.Name == "Hell's Messenger" then
                                        if v.Humanoid.Health > 0 then
                                            ...
                                            until v.Humanoid.Health <= 0 or not v.Parent or Tự động _Quest_Yama_3 == false
                                        end
                                    end
                                end
                            else
                        ...
                        until Tự động _Cursed_Dual_Katana == false or Tự động _Quest_Yama_3 == false or GetMaterial("Alucard Fragment") == 3
                    else
                                ...
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if v.Name == "Soul Reaper" then
                                        if v.Humanoid.Health > 0 then
                                            repeat wait()
                                                topos(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                                            until Tự động _Cursed_Dual_Katana == false or Tự động _Quest_Yama_3 == false or game:GetService("Workspace").Map:FindFirstChild("HellDimension")
                                        end
                                    end
                                end
                            else
    ...
    spawn(function()
        while wait() do
            if Tự động _Quest_Tushita_1 then
    ...
    spawn(function()
        while wait() do
            if Tự động _Quest_Tushita_2 then
                pcall(function()
                    if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 500 then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if Tự động _Quest_Tushita_2 and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                if (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2000 then
                                    repeat wait()
                                        EquipWeapon(Sword)
                                        topos(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                                    ...
                                    until v.Humanoid.Health <= 0 or not v.Parent or Tự động _Quest_Tushita_2 == false
                                end
                            end
                        end
                    else
    ...
    spawn(function()
        while wait() do
            if Tự động _Quest_Tushita_3 then
                pcall(function()
                            ...
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name == "Cake Queen" then
                                    if v.Humanoid.Health > 0 then
                                        ...
                                        until Tự động _Cursed_Dual_Katana == false or Tự động _Quest_Tushita_3 == false or game:GetService("Workspace").Map:FindFirstChild("HeavenlyDimension")
                                    end
                                end
                            end
                        else
                    ...
                    elseif game:GetService("Workspace").Map:FindFirstChild("HeavenlyDimension") then
                                ...
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if v.Name == "Cursed Skeleton" or v.Name == "Cursed Skeleton" or v.Name == "Heaven's Guardian" then
                                        if v.Humanoid.Health > 0 then
                                            ...
                                            until v.Humanoid.Health <= 0 or not v.Parent or Tự động _Quest_Tushita_3 == false
                                        end
                                    end
                                end
                            else
                        ...
                        until not Tự động _Cursed_Dual_Katana or not Tự động _Quest_Tushita_3 or GetMaterial("Alucard Fragment") == 6
                    end
                end)
            end
        end
    end)
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Soul Guitar Quest", Default = _G.QuestSoulGuitar })
    Toggle:OnChanged(function(Value)
...
Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Tự động  Holy Torch", Default = _G.Tự động HolyTorch })
    Toggle:OnChanged(function(Value)
        _G.Tự động HolyTorch = Value
        saveSettings()
        end)
        spawn(function()
        while wait() do
            if _G.Tự động HolyTorch then
                pcall(function()
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(5749.7861328125, 611.9736938476562, -276.2497863769531))
                    ...
                    repeat topos(CFrame.new(-10752, 417, -9366)) wait() until not _G.Tự động HolyTorch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-10752, 417, -9366)).Magnitude <= 10
					wait(1)
					repeat topos(CFrame.new(-11672, 334, -9474)) wait() until not _G.Tự động HolyTorch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-11672, 334, -9474)).Magnitude <= 10
					wait(1)
					repeat topos(CFrame.new(-12132, 521, -10655)) wait() until not _G.Tự động HolyTorch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-12132, 521, -10655)).Magnitude <= 10
					wait(1)
					repeat topos(CFrame.new(-13336, 486, -6985)) wait() until not _G.Tự động HolyTorch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-13336, 486, -6985)).Magnitude <= 10
					wait(1)
					repeat topos(CFrame.new(-13489, 332, -7925)) wait() until not _G.Tự động HolyTorch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-13489, 332, -7925)).Magnitude <= 10
                end)
            end
        end
    end)
...
Tabs.spl:AddSection("Tự động  Up Stats")
ToggleMelee = Tabs.spl:AddToggle("ToggleMelee", {Title = "Tự động  Melee",Description = "", Default = _G.Tự động _Stats_Melee })
ToggleMelee:OnChanged(function(Value)
    _G.Tự động _Stats_Melee = Value
    saveSettings()
    end)
ToggleDe = Tabs.spl:AddToggle("ToggleDe", {Title = "Tự động  Defense",Description = "", Default = _G.Tự động _Stats_Defense })
ToggleDe:OnChanged(function(Value)
    _G.Tự động _Stats_Defense = Value
    saveSettings()
    end)
ToggleSword = Tabs.spl:AddToggle("ToggleSword", {Title = "Tự động  Sword",Description = "", Default = _G.Tự động _Stats_Sword })
ToggleSword:OnChanged(function(Value)
    _G.Tự động _Stats_Sword = Value
    saveSettings()
    end)
ToggleGun = Tabs.spl:AddToggle("ToggleGun", {Title = "Tự động  Gun", Description = "",Default = _G.Tự động _Stats_Gun })
ToggleGun:OnChanged(function(Value)
    _G.Tự động _Stats_Gun = Value
    saveSettings()
    end)
ToggleFruit = Tabs.spl:AddToggle("ToggleFruit", {Title = "Tự động  Demon Fruit",Description = "", Default = _G.Tự động _Stats_Devil_Fruit })
ToggleFruit:OnChanged(function(Value)
    _G.Tự động _Stats_Devil_Fruit = Value
    saveSettings()
    end)
spawn(function()
    while wait() do
        if _G.Tự động _Stats_Devil_Fruit then
            local args = {
                [1] = "AddPoint",
                [2] = "Demon Fruit",
                [3] = 3
...
spawn(function()
    while wait() do
        if _G.Tự động _Stats_Sword then
            local args = {
                [1] = "AddPoint",
                [2] = "Sword",
                [3] = 3
...
spawn(function()
    while wait() do
        if _G.Tự động _Stats_Defense then
            local args = {
                [1] = "AddPoint",
                [2] = "Defense",
                [3] = 3
...
spawn(function()
    while wait() do
        if _G.Tự động _Stats_Melee then
            local args = {
                [1] = "AddPoint",
                [2] = "Melee",
                [3] = 3
...
------------------------------------------------------------------------------------------------------------------------------------
    Tabs.De:AddSection("thằng bán trái mất dạy Tab ")
    Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Tự động  Random Fruit", Default = _G.RandomFruit })
    ...
    Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Tự động  Store Fruit", Default = _G.Tự động StoreFruit })

    Toggle:OnChanged(function(Value)
        _G.Tự động StoreFruit = Value
        saveSettings()
    end)
    
    spawn(function()
    while task.wait() do
        if _G.Tự động StoreFruit then
            pcall(function()
                if _G.Tự động StoreFruit then
		...
		Tabs.De:AddButton({
        Title = "Open thằng bán trái mất dạy Shop",
        Description = "",
        Callback = function()
  ...
  "Leopard-Leopard"
    ...
    Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Buy Fruit", Default = _G.Tự động BuyFruitSniper })

    Toggle:OnChanged(function(Value)
        _G.Tự động BuyFruitSniper = Value
        saveSettings()
    end)
  ...
  pcall(function()
   while wait(.1) do
   if _G.Tự động BuyFruitSniper then
   game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
   ...
   Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Buy MicroChip", Default = _G.Tự động BuyChip })
    Toggle:OnChanged(function(Value)
   _G.Tự động BuyChip = Value
   saveSettings()
		end)
    ...
    Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Next Island", Default = _G.Tự động _Dungeon })
    Toggle:OnChanged(function(Value)
   _G.Tự động _Dungeon = Value
   saveSettings()
		end)
...
Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Awakening Fruit", Default = _G.Tự động _Awakener })
    Toggle:OnChanged(function(Value)
   _G.Tự động _Awakener = Value
   saveSettings()
		end)
...
local Toggle = Tabs.pvp:AddToggle("MyToggle", {
    Title = "Tự động  Kill Player",
    Default = _G.Tự động _Kill_Ply
})

Toggle:OnChanged(function(Value)
    _G.Tự động _Kill_Ply = Value
    saveSettings()
    
    spawn(function()
        while wait() do
            if _G.Tự động _Kill_Ply then
                pcall(function()
                    if _G.SelectPly ~= nil then
                        ...
                        if selectedPlayer and selectedPlayer.Character and selectedPlayer.Character:FindFirstChild("Humanoid") then
                            if selectedPlayer.Character.Humanoid.Health > 0 then
                                ...
                                until selectedPlayer.Character.Humanoid.Health <= 0 or not selectedPlayer or not _G.Tự động _Kill_Ply
                            end
                        end
                    end
                end)
    ...
    local Toggle = Tabs.pvp:AddToggle("MyToggle", {
    Title = "Tự động  Kill Player Quest",
    Default = _G.Tự động PlayerHunter
})

Toggle:OnChanged(function(Killzps)
    _G.Tự động PlayerHunter = Killzps
    saveSettings()
    
    spawn(function()
        game:GetService("RunService").Heartbeat:Connect(function()
            pcall(function()
                if _G.Tự động PlayerHunter then
                    ...
                    for i, v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, v.Name) then
                            repeat
                                ...
                                game:GetService("VirtualUser"):CaptureController()
                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
                            until not _G.Tự động PlayerHunter or v.Humanoid.Health <= 0
                            Useskill = false
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                        end
                    end
...
Toggle = Tabs.pvp:AddToggle("MyToggle", {Title = "Aimbot All Skills", Default = AimSkillNearest })
    ...
    Toggle = Tabs.pvp:AddToggle("MyToggle", {Title = "Tự động  Turn On Pvp", Default = _G.EnabledPvP })
    Toggle:OnChanged(function(value)
        _G.EnabledPvP = value
        saveSettings()
        end)
...
local USERACEV3 = Tabs.pvp:AddToggle("Use V3", {Title = "Tự động  Use Race v3", Default = false })
local USERACEV4 = Tabs.pvp:AddToggle("Use V4", {Title = "Tự động  Use Race v4", Default = false })
...
local miricheat = Tabs.cailon:AddToggle("miricheat", {
    ...
    Default = _G.Tự động ChestMirage })
    miricheat:OnChanged(function(value)
    _G.Tự động ChestMirage = value
    saveSettings()
end)
_G.MagnitudeAdd = 0
spawn(function()
	while wait() do 
		if _G.Tự động ChestMirage then
			for i,v in pairs(game:GetService("Workspace"):GetChildren()) do 
				if v.Name:find("FragChest") then
					if game:GetService("Workspace"):FindFirstChild(v.Name) then
						if (v.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 5000+_G.MagnitudeAdd then
							...
							until _G.Tự động ChestMirage == false or not v.Parent
							topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
							_G.MagnitudeAdd = _G.MagnitudeAdd+1500
							break
						end
        ...
        Toggle = Tabs.cailon:AddToggle("MyToggle", {Title = "Tween Mystic Island", Default = _G.Tự động MysticIsland })
    Toggle:OnChanged(function(Value)
        _G.Tự động MysticIsland = Value
        saveSettings()
        end)
        spawn(function()
            pcall(function()
                while wait() do
                    if _G.Tự động MysticIsland then
    ...
    Toggle = Tabs.cailon:AddToggle("MyToggle", {Title = "Look Moon", Default = _G.Tự động DooHee })
    Toggle:OnChanged(function(Value)
        _G.Tự động DooHee = Value
        saveSettings()
        end)
        spawn(function()
    while wait() do
        pcall(function()
            if _G.Tự động DooHee then
...
Toggle = Tabs.cailon:AddToggle("MyToggle", {Title = "Farm and turn on V4", Default = _G.Tự động _Bone })
    Toggle:OnChanged(function(Value)
        _G.Tự động _Bone = Value
        saveSettings()
    end)
...
local DieAfterTrials = Tabs.cailon:AddToggle("Tự động dieafter", {Title = "Tự động  Buy Gear", Default = Tự động dieafter })
DieAfterTrials:OnChanged(function(starts)
	Tự động dieafter = starts
    saveSettings()
end)
    spawn(function()
        while task.wait() do 
            pcall(function()
                if Tự động dieafter then 
...
local Toggle = Tabs.cailon:AddToggle("Tự động  Complete Trial", { Title = "Tự động  Complete Trial", Default = false })

Toggle:OnChanged(function(Value)
    _G.Tự động Complete_Race = Value
    StopTween(_G.Tự động Complete_Race)
end)
...
spawn(
    function()
        pcall(
            function()
                while wait() do
                    if _G.Tự động Complete_Race then
                        if game:GetService("Players").LocalPlayer.Data.Race.Value == "Human" then
                            for i, v in pairs(game.Workspace.Enemies:GetDescendants()) do
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    pcall(function()
                                        repeat 
                                            ...
                                            v.HumanoidRootPart.CanCollide = false
                                            sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                                        until not _G.Tự động Complete_Race or not v.Parent or v.Humanoid.Health <= 0
                                    end
                                    )
                                end
                            end
                        ...
                        if v.Name == _G.SelectedBoat then
                            if v:FindFirstChild("MyBoatEsp") then
                                if not game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit then
                                    if ((CheckShark() and _G.Tự động KillShark) or (game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") and _G.Tự động Terrorshark) or (CheckPiranha() and _G.Tự động KillPiranha) or (game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") and _G.Tự động KillFishCrew) or (game:GetService("Workspace").Enemies:FindFirstChild("FishBoat") and _G.RelzFishBoat) or (game:GetService("Workspace").Enemies:FindFirstChild("PirateBrigade") and _G.RelzPirateBrigade) or (game:GetService("Workspace").Enemies:FindFirstChild("PirateGrandBrigade") and _G.RelzPirateGrandBrigade) or (CheckSeaBeast() and _G.Tự động SeaBest)) then
                                        if stoppos then stoppos:Stop() end
                                    else
                                    ...
                                    until ((CheckShark() and _G.Tự động KillShark) or (game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") and _G.Tự động Terrorshark) or (CheckPiranha() and _G.Tự động KillPiranha) or (game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") and _G.Tự động KillFishCrew) or (game:GetService("Workspace").Enemies:FindFirstChild("FishBoat") and _G.RelzFishBoat) or (game:GetService("Workspace").Enemies:FindFirstChild("PirateBrigade") and _G.RelzPirateBrigade) or (game:GetService("Workspace").Enemies:FindFirstChild("PirateGrandBrigade") and _G.RelzPirateGrandBrigade) or (CheckSeaBeast() and _G.Tự động SeaBest)) or not game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit or not _G.SailBoat
...
spawn(function()
    ...
    spawn(function()
        while wait() do
            pcall(function()
                if _G.SailBoat then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") and _G.Tự động KillFishCrew then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") then
                                if v.Name == "Fish Crew Member" then
                                    ...
                                    repeat task.wait()
                                        ...
                                        NeedAttacking = true
                                        _G.SeaSkill = false
                                    until not _G.Tự động KillFishCrew or not v.Parent or v.Humanoid.Health <= 0
                                    StartMagnet = false
                                    end
                                end
                            end
                    ...
                    elseif CheckSeaBeast() and _G.Tự động SeaBest then
                        if game:GetService("Workspace"):FindFirstChild("SeaBeasts") then
                            for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
                                ...
                                until not _G.Tự động SeaBest or CheckSeaBeast() == false or not v:FindFirstChild("Humanoid") or not v:FindFirstChild("HumanoidRootPart") or v.Humanoid.Health < 0 or not v.Parent
                                Skillaimbot = false
                                _G.SeaSkill = false
                                else
                                Skillaimbot = false
                    ...
                    elseif game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") and _G.Tự động Terrorshark then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") then
                                if v.Name == "Terrorshark" then
                                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                        ...
                                        until not  _G.Tự động Terrorshark or not v.Parent or v.Humanoid.Health <= 0
                                    end
                                end
                            end
                        end
                    elseif CheckPiranha() and _G.Tự động KillPiranha then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if game:GetService("Workspace").Enemies:FindFirstChild("Piranha") then
                                if v.Name == "Piranha" then
                                    ...
                                    repeat task.wait()
                                        ...
                                        NeedAttacking = true
                                        _G.SeaSkill = false
                                    until not _G.Tự động KillPiranha or not v.Parent or v.Humanoid.Health <= 0
                                    end
                                end
                            end
                        end
                    elseif CheckShark() and _G.Tự động KillShark then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if game:GetService("Workspace").Enemies:FindFirstChild("Shark") then
                                if v.Name == "Shark" then
                                    ...
                                    repeat task.wait()
                                        ...
                                        NeedAttacking = true
                                        _G.SeaSkill = false
                                    until not _G.Tự động KillShark or not v.Parent or v.Humanoid.Health <= 0
                                    end
                                end
                            end
                        end
    ...
    local toggleshark = Tabs.Se:AddToggle("toggleshark", {Title = "Tự động  Kill Shark",Description = "Enable for kill normal shark if have", Default = _G.Tự động KillShark })
      toggleshark:OnChanged(function(value)
          _G.Tự động KillShark = value
        saveSettings()
    end)
local piranhatoggle = Tabs.Se:AddToggle("piranhatoggle", {Title = "Tự động  Kill Piranha",Description = "Enable for kill Piranha if have", Default = _G.Tự động KillPiranha })
      piranhatoggle:OnChanged(function(value)
          _G.Tự động KillPiranha = value
        saveSettings()
    end)
    local fishcrew = Tabs.Se:AddToggle("fishcrew", {Title = "Tự động  Kill Piranha",Description = "Enable for kill Crew Fish if have", Default = _G.Tự động KillFishCrew })
      fishcrew:OnChanged(function(value)
          _G.Tự động KillFishCrew = value
        saveSettings()
    end)
    -- spawn(function()
    --     while wait() do
    --         pcall(function()
    --             if _G.Tự động KillShark and  World3 then
    --                 for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
    --                     if v.Name == "Shark" then
    ...
    --     while wait() do
    --         pcall(function()
    --             if _G.Tự động KillPiranha and World3 then
    --                 for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
    --                     if v.Name == "Piranha" then
    --                         if (v.HumanoidRootPart.CFrame.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Position).Magnitude <= 500 then
    --                         if game:GetService("Workspace").Enemies:FindFirstChild(v.Name) then
    ...
    --     while wait() do
    --         pcall(function()
    --             if _G.Tự động KillFishCrew and  World3 then
    --                 for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
    --                     if v.Name == "Fish Crew Member" then
    --                         if (v.HumanoidRootPart.CFrame.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Position).Magnitude <= 500 then
    --                         if game:GetService("Workspace").Enemies:FindFirstChild(v.Name) then
    ...
    -- spawn(function()
    --     while wait() do
    --         if  _G.Tự động Terrorshark and World3 then
    --             pcall(function()
    --                 if game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") then
    --                     for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
    --                         if v.Name == "Terrorshark" then
    ...
    --     while wait() do
    --         pcall(function()
    --             if _G.Tự động Terrorshark then
    ...
    --                     repeat wait()
    --                     NeedAttacking = true
    --                     until not _G.Tự động Terrorshark
    --                 end
    --             end
    --         end)
    --     end
...
ghostship:OnChanged(function(value)
   ...
   local piratebrigade = Tabs.Se:AddToggle("piratebrigade", {
    Title = "Tự động  Kill Pirate Brigade",
...
local grand = Tabs.Se:AddToggle("grand", {
    Title = "Tự động  Kill Pirate Grand Brigade",
...
seabitch:OnChanged(function(value)
    ...
    function CheckSeaBeast()
        ...
        --                             AimBotSkillPosition = v.HumanoidRootPart.CFrame.Position
        --                             TP2(CFrameSeaBeast)
        --                         until not _G.Tự động SeaBest or not v:FindFirstChild("Humanoid") or not v:FindFirstChild("HumanoidRootPart") or v.Humanoid.Health < 0 or not v.Parent
        --                         Skillaimbot = false
        --                         _G.SeaSkill = false
        --                         end
        --                     end
...
boatclip:OnChanged(function(state)
    ...
    Title = "Press W Tự động ",
    Description = "",
    Default = _G.Tự động PressW
})
wpress:OnChanged(function(state)
    _G.Tự động PressW = state 
        saveSettings()
end)
            spawn(function()
                while wait() do
                    pcall(function()
                        if _G.Tự động PressW then
...
gunsk:OnChanged(function(value)
    ...
    Title = "Use Skill Z",
    Description = "Use Skill Z thằng bán trái mất dạy",
...
fruitskz:OnChanged(function(value)
    ...
    Title = "Use Skill X",
    Description = "Use Skill X thằng bán trái mất dạy",
...
fruitskx:OnChanged(function(value)
    ...
    Title = "Use Skill C",
    Description = "Use Skill C thằng bán trái mất dạy",
...
fruitskc:OnChanged(function(value)
    ...
    Title = "Use Skill V",
    Description = "Use Skill V thằng bán trái mất dạy",
...
fruitskv:OnChanged(function(value)
    ...
    Title = "Use Skill F",
    Description = "Use Skill F thằng bán trái mất dạy",
...
DropdownTweenSpeed:OnChanged(function(Value)
    ...
    Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Tự động  Haki", Default = true })
    Toggle:OnChanged(function(Value)
        _G.Tự động HAKI = Value
        saveSettings()
    end)
    spawn(function()
    while wait(.1) do
        if _G.Tự động HAKI then 
            if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
                local args = {
                    [1] = "Buso"
                }
...
Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Tự động  Ken Haki", Default = _G.Tự động Ken })
    Toggle:OnChanged(function(Value)
        _G.Tự động Ken = Value
        saveSettings()
    end)
    spawn(function()
        while wait() do
            pcall(function()
                if _G.Tự động Ken then
                    repeat task.wait()
                    ...
                    until game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") or not _G.Tự động Ken
                end
            end)
        end
    end)    
    
    local Tự động click = Tabs.Settings:AddToggle("Tự động click", {Title = "Tự động  Clicker", Description = "", Default = false })
Tự động click:OnChanged(function(Value)
   UFFF = Value
   saveSettings()
end) 
    ...
    while task.wait() do
        spawn(function()
            if _G.BringMonster then
                CheckQuest()
                for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if _G.Tự động Farm and StartMagnet and v.Name == Mon and (Mon == "Factory Staff" or Mon == "Monkey" or Mon == "Dragon Crew Warrior" or Mon == "Dragon Crew Archer") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 220 then
                        ...
                        sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
                        task.wait(0.1) -- Thêm khoảng thời gian chờ 0.1 giây giữa mỗi lần di chuyển mob
                    elseif _G.Tự động Farm and StartMagnet and v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
                        v.HumanoidRootPart.Size = Vector3.new(70, 70, 70)
                        v.HumanoidRootPart.CFrame = PosMon
                        v.Humanoid:ChangeState(14)
                        v.HumanoidRootPart.CanCollide = false
...
task.spawn(function()
	while task.wait() do
		pcall(function()
			if _G.Tự động FarmNearest and Tự động FarmNearestMagnet or SelectMag and _G.BringMonster then
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
					if not string.find(v.Name,"Boss") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
						if InMyNetWork(v.HumanoidRootPart) then
							v.HumanoidRootPart.CFrame = PosMon
...
------------------------------------------------------------------------------------------------------------------------------------
Tabs.Vl:AddSection("Nhận free moin thứ")
...
Tabs.Vl:AddButton({
Title = "nhận free Level/Beli/EXP",
Description = "",
Callback = function()
    local plr = game:GetService("Players").LocalPlayer
    local Notification = require(game:GetService("ReplicatedStorage").Notification)
    ...
    Notification.new("Earned <Color=Red>9,999,999,999,999 Exp.<Color=/> (+ None)"):Display()
    Notification.new("Earned <Color=Black>$9,999,999,999,999<Color=/>"):Display()
...
------------------------------------------------------------------------------------------------------------------------------------
    ...
    local Input = Tabs.Ms:AddInput("Input", {
        Title = "Job Id sever discord của bố",
        Default = "",
    ...
    Tabs.Ms:AddButton({
        Title = "Copy Sever ID discord của tao mấy thg lol",
        Description = "",
        Callback = function()
    ...
    Tabs.Ms:AddButton({
        Title = "Join Sever id discord của tao",
        Description = "",
        Callback = function()
...
game:GetService("TeleportService"):TeleportToPlaceInstance(game.placeId,_G.Job, game.Players.LocalPlayer)
  ...
  local Rejoin = Tabs.Ms:AddToggle("MyToggle", {Title = "Tự động  Rejoin If Disconnect or Kicked", Default = true })
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "BID HUB";
    Text = "LOADING SCRIPT THÀNH CÔNG RỒI MẤY THG LOL";
    Icon = "https://create.roblox.com/store/asset/89249864626583/memecheemschui?externalSource=www";
    Duration = 7
})
            ...
            if UFFF then 
                pcall(function()
                    if conchosetting and type(conchosetting) == "table" then 
                        if conchosetting and conchosetting["Cày Thông Thạo"] then 
                            ToiCanOxi = 2 
                            atack()
